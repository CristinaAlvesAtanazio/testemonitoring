...
export class Testemonitoring_WebClient {
     ...
     * @return OK
     */
    metricTest(): Promise<void> {
        let url_ = this.baseUrl + "/api/metric-test";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMetricTest(_response);
        });
    }

    protected processMetricTest(response: Response): Promise<void> {
