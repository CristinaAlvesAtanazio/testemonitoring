using testemonitoring.Domain.Events;
using Microsoft.Extensions.Logging;

namespace testemonitoring.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("testemonitoring Domain Event: {DomainEvent}", notification.GetType().Name);
