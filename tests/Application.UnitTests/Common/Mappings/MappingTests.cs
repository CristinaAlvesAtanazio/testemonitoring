...
using testemonitoring.Application.Common.Models;
using testemonitoring.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using testemonitoring.Application.TodoLists.Queries.GetTodos;
using testemonitoring.Domain.Entities;
using Microsoft.Extensions.Logging;
using NUnit.Framework;

namespace testemonitoring.Application.UnitTests.Common.Mappings;
